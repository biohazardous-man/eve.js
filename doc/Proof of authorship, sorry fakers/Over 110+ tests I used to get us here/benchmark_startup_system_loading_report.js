...
const MODE_SPECS = [
  ...
  { mode: 4, label: "OnGoingLazy", accent: "\x1b[92m" },
];
const ANSI = {
  reset: "\x1b[0m",
  bold: "\x1b[1m",
...
async function main() {
  ...
  console.log(
    `${color("Scope:", ANSI.bold + ANSI.white)} compare mode 1 (lazy), mode 2 (high-sec), mode 3 (full New Eden), and mode 4 (OnGoingLazy) using fresh worker processes.`,
  );
  console.log(
